...
set "SOURCE_PATH=C:\Users\88691\AppData\Local\Temp\arduino\sketches\44BA67EC915B1A38E821ABC5174A1D61\FactorySense.ino.elf"

:: Set the destination folder (where the .ino file is located)
set "DEST_FOLDER=F:\PHD\Arduino_Projects\FactorySense\FactorySense_v19.0"
