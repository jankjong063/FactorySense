...
set "SOURCE_PATH=C:\Users\88691\AppData\Local\Temp\arduino\sketches\13351F33AF240C4749FD1AD8D4609327\FactorySense.ino.elf"

:: Set the destination folder (where the .ino file is located)
set "DEST_FOLDER=F:\PHD\Arduino_Projects\FactorySense\FactorySense_v9.0"
