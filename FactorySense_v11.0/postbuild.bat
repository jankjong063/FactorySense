...
set "SOURCE_PATH=C:\Users\88691\AppData\Local\Temp\arduino\sketches\7D5067C0D6AD8E4403F073C30B0F5DB6\FactorySense.ino.elf"

:: Set the destination folder (where the .ino file is located)
set "DEST_FOLDER=F:\PHD\Arduino_Projects\FactorySense\FactorySense_v11.0"
