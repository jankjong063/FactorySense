...
set "SOURCE_PATH=C:\Users\88691\AppData\Local\Temp\arduino\sketches\48270F2BBD790752B1C78A89B0AEF675\FactorySense.ino.elf"

:: Set the destination folder (where the .ino file is located)
set "DEST_FOLDER=F:\PHD\Arduino_Projects\FactorySense\FactorySense_v1.0"
