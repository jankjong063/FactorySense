...
set "SOURCE_PATH=C:\Users\88691\AppData\Local\Temp\arduino\sketches\CA24FCF46BBEFA1819D204A1B005F715\FactorySense.ino.elf"

:: Set the destination folder (where the .ino file is located)
set "DEST_FOLDER=F:\PHD\Arduino_Projects\FactorySense\FactorySense_v18.0"
