...
set "SOURCE_PATH=C:\Users\88691\AppData\Local\Temp\arduino\sketches\123EFBBB890C5907334A5079FCA2FFE2\FactorySense.ino.elf"

:: Set the destination folder (where the .ino file is located)
set "DEST_FOLDER=F:\PHD\Arduino_Projects\FactorySense\FactorySense_v8.0"
