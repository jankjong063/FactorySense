...
set "SOURCE_PATH=C:\Users\88691\AppData\Local\Temp\arduino\sketches\2FF6555A5B2A410873AD531C701AB8DE\FactorySense.ino.elf"

:: Set the destination folder (where the .ino file is located)
set "DEST_FOLDER=F:\PHD\Arduino_Projects\FactorySense\FactorySense"
