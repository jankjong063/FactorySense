...
set "SOURCE_PATH=C:\Users\88691\AppData\Local\Temp\arduino\sketches\16AAC84F5A2644E614D70870993C4E75\FactorySense.ino.elf"

:: Set the destination folder (where the .ino file is located)
set "DEST_FOLDER=F:\PHD\Arduino_Projects\FactorySense\FactorySense_v5.0"
