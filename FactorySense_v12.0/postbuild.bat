...
set "SOURCE_PATH=C:\Users\88691\AppData\Local\Temp\arduino\sketches\1A29A9773103E787666574BF5BA21392\FactorySense.ino.elf"

:: Set the destination folder (where the .ino file is located)
set "DEST_FOLDER=F:\PHD\Arduino_Projects\FactorySense\FactorySense_v12.0"
