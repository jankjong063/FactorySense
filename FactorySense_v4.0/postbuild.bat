...
set "SOURCE_PATH=C:\Users\88691\AppData\Local\Temp\arduino\sketches\EFC401B72FC37082A8BCD779BB1BD637\FactorySense.ino.elf"

:: Set the destination folder (where the .ino file is located)
set "DEST_FOLDER=F:\PHD\Arduino_Projects\FactorySense\FactorySense_v4.0"
