...
set "SOURCE_PATH=C:\Users\88691\AppData\Local\Temp\arduino\sketches\7A76DD401DD78874F52CA7E5204BA0C3\FactorySense.ino.elf"

:: Set the destination folder (where the .ino file is located)
set "DEST_FOLDER=F:\PHD\Arduino_Projects\FactorySense\FactorySense_v13.0"
