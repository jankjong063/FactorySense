...
set "SOURCE_PATH=C:\Users\88691\AppData\Local\Temp\arduino\sketches\8B20EE76DF5EE87C3C7CC3E032F1587E\FactorySense.ino.elf"

:: Set the destination folder (where the .ino file is located)
set "DEST_FOLDER=F:\PHD\Arduino_Projects\FactorySense\FactorySense_v10.0"
