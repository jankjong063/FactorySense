...
set "SOURCE_PATH=C:\Users\88691\AppData\Local\Temp\arduino\sketches\23811DE7C7ECFD62DDC852F6A39913FB\FactorySense.ino.elf"

:: Set the destination folder (where the .ino file is located)
set "DEST_FOLDER=F:\PHD\Arduino_Projects\FactorySense\FactorySense_v16.0"
