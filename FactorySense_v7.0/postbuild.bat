...
set "SOURCE_PATH=C:\Users\88691\AppData\Local\Temp\arduino\sketches\DBE48D4E41C5B3A23E9D2B714E6D606B\FactorySense.ino.elf"

:: Set the destination folder (where the .ino file is located)
set "DEST_FOLDER=F:\PHD\Arduino_Projects\FactorySense\FactorySense_v7.0"
