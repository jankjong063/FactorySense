...
set "SOURCE_PATH=C:\Users\88691\AppData\Local\Temp\arduino\sketches\32F172F0BE0BD1F9CC1159ED7D49171B\FactorySense.ino.elf"

:: Set the destination folder (where the .ino file is located)
set "DEST_FOLDER=F:\PHD\Arduino_Projects\FactorySense\FactorySense_v17.0"
