...
set "SOURCE_PATH=C:\Users\88691\AppData\Local\Temp\arduino\sketches\56CB97C34648020A5BD48E2CCE9E029D\FactorySense.ino.elf"

:: Set the destination folder (where the .ino file is located)
set "DEST_FOLDER=F:\PHD\Arduino_Projects\FactorySense\FactorySense_v6.0"
