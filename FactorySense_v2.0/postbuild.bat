...
set "SOURCE_PATH=C:\Users\88691\AppData\Local\Temp\arduino\sketches\E52174E431B584CA0B529B205947E6B4\FactorySense.ino.elf"

:: Set the destination folder (where the .ino file is located)
set "DEST_FOLDER=F:\PHD\Arduino_Projects\FactorySense\FactorySense_v2.0"
